      ...
      of: [
        {
          ...
          fields: [
            ...
            {
              name: 'logoBlackBg',
              title: 'Logo 1: Schwarzer Hintergrund',
              description: 'Aktivieren, wenn das Logo einen schwarzen Hintergrund braucht (z.B. bei hellen Logos). Hat Vorrang vor dem weißen Hintergrund.',
              type: 'boolean',
              initialValue: false,
            },
            {
            ...
            {
              name: 'logo2BlackBg',
              title: 'Logo 2: Schwarzer Hintergrund',
              description: 'Aktivieren, wenn das Logo einen schwarzen Hintergrund braucht (z.B. bei hellen Logos). Hat Vorrang vor dem weißen Hintergrund.',
              type: 'boolean',
              initialValue: false,
            },
