          ...
          <div className="mt-14 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {wenCards.map((item) => (
              ...
              >
                ...
                <span className="relative z-10 w-full text-center text-xs sm:text-sm lg:text-lg font-bold uppercase tracking-wide group-hover:text-sc-orange transition-colors duration-300">
                  {item.label}
                </span>
              </Link>
            ))}
