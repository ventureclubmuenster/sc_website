...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { url: '/startups-muenster', priority: 0.8, changeFrequency: 'monthly' as const },
    ...
    { url: '/tickets', priority: 0.9, changeFrequency: 'weekly' as const },
    { url: '/speaker', priority: 0.8, changeFrequency: 'weekly' as const },
    { url: '/partner', priority: 0.7, changeFrequency: 'monthly' as const },
    { url: '/formate', priority: 0.6, changeFrequency: 'monthly' as const },
    { url: '/besucher', priority: 0.6, changeFrequency: 'monthly' as const },
