    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {cards.map((card, i) => (
        ...
        >
          ...
          {/* Default title + subheader - visible, hides on hover */}
          <div className="absolute inset-0 flex flex-col items-center justify-center opacity-100 group-hover:opacity-0 transition-opacity duration-500">
            <span
            ...
            {card.subheader && (
              <span
                className="text-white text-sm md:text-base mt-2 font-semibold"
