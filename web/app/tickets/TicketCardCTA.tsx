...
export default function TicketCardCTA() {
  ...
  return (
    <a
      className="w-full inline-flex items-center justify-center gap-2 px-8 py-5 rounded-full font-bold text-base md:text-lg text-white cursor-pointer gradient-bg no-underline shadow-lg shadow-sc-orange/30"
      href={TICKET_URL}
      target="_blank"
