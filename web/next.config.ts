...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://connect.mailerlite.com https://*.sanity.io https://www.google-analytics.com https://*.google-analytics.com https://*.googletagmanager.com https://www.google.com https://api.stripe.com",
